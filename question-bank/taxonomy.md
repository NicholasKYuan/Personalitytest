...
> 母题库共 2117 题。**每道题均为融合题**——同时映射九型人格、MBTI、霍兰德、盖洛普优势四个体系中至少 2 个的维度倾向，理想 3-4 个。
> 题库按**主题类别**组织，10 个类别各约 170-240 题。
> 新增117题覆盖：家长视角(36题)、青少年场景(25题)、新量表类型(likert-5/likert-7/ranking, 41题)、holland R型补强(26题)。
...
| 霍兰德 | 6 类型每型 ≥ 2 题有 score 贡献（R型 ≥ 1，因 R 型题库偏少）|
...
### 4. 难度分布
难度 2 约 36 题、3 约 54 题、4 约 24 题、5 约 6 题。

### 5. 反向计分题
至少 12 题为 `reverse=true`。
